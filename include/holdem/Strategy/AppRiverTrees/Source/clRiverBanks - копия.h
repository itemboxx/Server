...
public:
	...
	int	FillRiverEV(clRootRiverTree *root, int nbHero, vector <float> &ev);
	int	FillRiverEV(clRootRiverTree *root, vector <float> *ev, tpUnfindRiverTree *ptr);
	int	FillRiverEV(int nbCls, clRiverDat &datIn, clRootRiverTree *root, vector <float> *ev);
	void    InitFastTree();
	int		FastSearchR(clRiverDat &dat, double &dist);
	bool	GetTreeForRoot(clRoot &root, clHoldemTree &tree, tpUnfindRiverTree *ptr);
...
void	RiverBankReCalcEv(clRootRiverTree *root, int nbHero, clRiverDat &datIn, clRiverDat &dat, vector <float> &evIn, vector <float> &ev);
