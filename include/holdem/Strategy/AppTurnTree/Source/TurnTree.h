...
struct tpStreetDatGH
{
	...
	void	operator +=(tpStreetDatGH &val);
...
public:
	...
	bool	CreateTurnDatQuick(clStreetDat &dat);
	...
	void	CompactGH(double ur, int cnMin, clStreetDat dat) { CompactGH(this, ur, cnMin, dat); CalcIndex();}
	static void	CompactGH(clInComeDataRoot *id, double minW, int cnMin, clStreetDat dat);
...
void	CompactGHTurn(clRoot &hs, double val, int cnHand, int *nbH);
//---------------------------------------------------------------------------------------------------------------------------------------------------
#endif
